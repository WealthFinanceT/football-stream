      ...
      <div className="mx-auto max-w-6xl px-4 py-10 sm:px-6 lg:px-8">
        <div className="mb-10 flex flex-col gap-4 rounded-[32px] border border-white/10 bg-card/80 px-6 py-8 shadow-2xl shadow-black/20 sm:px-10 lg:flex-row lg:items-center lg:justify-between lg:gap-6">
          <div className="max-w-3xl">
            ...
            <h1 className="mt-3 text-4xl font-semibold tracking-tight text-foreground sm:text-5xl">Browse live sports fixtures</h1>
            <p className="mt-4 max-w-2xl text-sm leading-7 text-slate-400">
              Explore live matches now or jump to the full match hub for the latest fixtures and schedules across sports.
            </p>
          </div>
        ...
        <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
          ...
          >
            ...
            <h2 className="mt-4 text-2xl font-semibold text-white">Featured live sports stream feed</h2>
