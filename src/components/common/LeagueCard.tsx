...
export function LeagueCard({
  ...
  return (
    <motion.div whileHover={{ y: -6 }} transition={{ duration: 0.2, ease: "easeOut" }}>
      <Link
        href={href}
        className="group flex h-full flex-col justify-between rounded-[28px] border border-white/10 bg-slate-950/80 p-6 transition duration-300 hover:border-emerald-400/40"
      >
